      ...
      <div class="row">
              ...
              <div class="row">
                <div class="col-sm-12 collapse infoContainer" id="collapse-{{ $client['id']}}">
                    <div class="row">
                      ...
                      <div class="col-sm-4" style="margin-top:50px;">
                        <label>Edad: </label> &nbsp; {{ (($client['age'] != 0)? $client['age'].' años' : 'S/D') }}
                      </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 15px;">
                      ...
                      <div class="col-sm-8">
                        <label>Visión:</label> <br> {{ $client['vision'] }}
                      </div>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table goalTable">
                          ...
                          <tbody>
                            ...
                            @ELSE
                              <tr>
                                <td colspan="4">El cliente aún no ha creado metas</td>
                              </tr>
                            @ENDIF
                          </tbody>
                        </table>
        ...
        @ELSE
          <div class="col-sm-8 offset-md-2 text-center infoBlock infoName">
                Aún no has tenido sesiones con algun cliente.
          </div>
        @ENDIF
