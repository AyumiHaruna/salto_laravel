@extends('layouts.mainLayoutSession')
  ...
  @section('title') AUDIOS - MODIFICAR AUDIO  @endsection

  @section('extraheader')
    <link rel="stylesheet" href="{{ asset('css/resources/audios_admin.css') }}">
  @endsection

  @section('in_page_title') MODIFICAR AUDIO  @endsection
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12 mainContainer">
          ...
          <form name="formAudio" id="formAudio" action="{{ url('/Admin_Audios/mod_audio/save') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8 progress_block">
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        <img src="{{ asset('img/web/admin_elements/sound_on.png') }}" alt="" class="img_lock" id="preview_audio"> <span class="span_lock" id="audio_span">Audio actual: {{ $data['url'] }}</span>
                      </div>
                      <div class="col-sm-12">
                  ...
                  <input type="hidden" name="id_audio" id="id_audio" value="{{ $data['id'] }}">
