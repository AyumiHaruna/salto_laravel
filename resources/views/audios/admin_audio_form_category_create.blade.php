@extends('layouts.mainLayoutSession')
  ...
  @section('title') AUDIOS - NUEVA CATEGORÍA  @endsection

  @section('extraheader')
    <link rel="stylesheet" href="{{ asset('css/resources/audios_admin.css') }}">
  @endsection

  @section('in_page_title') NUEVA CATEGORÍA  @endsection

  @section('content')
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12 mainContainer">
          <form name="formAudio" id="formAudio" action="{{ url('/Admin_Audios/new_category/save') }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
              ...
              <div class="col-sm-6 form_sub_block">
                <div class="row">
                  ...
                  <div class="col-sm-12 form_block_element" style="background-image: url('{{ asset('img/web/admin_elements/titulo.png') }}')">
                    <input type="text" name="category" class="form-control" placeholder="Nombre" id="category" value="{{ old('category') }}" required>
                  </div>
                  ...
                  <div class="col-sm-12 text-right">
                    <button type="button" name="button" class="form_action_button" id="form_submit" style="background-image: url('{{ asset('img/web/admin_elements/Boton_publicar_cancelar.png') }}')">Agregar</button>
      ...
      $(document).ready(function() {
          ...
          $("#form_submit").click(function(){
            if( $("#url").val() != '' ) {
              ...
              alert('falta cargar imagen miniatura');
            }
          });
