                ...
                <form id="mainForm" action="" method="post">
                  ...
                  <div class="row" id="form_info_container">
                    ...
                    <div class="col-md-12 span_container_description">
                      <label class="span_label">Descripción: </label> <textarea type="text" class="form-control" id="span_description" name="span_description" readOnly>{{ old('span_description') }}</textarea>
                    </div>
                    ...
                    <div class="col-md-12 span_container_end_datetime">
                      <label class="span_label">Fecha y hora de Término: </label> <input type="text" class="form-control" id="span_end_datetime" name="span_end_datetime" value="{{ old('span_end_datetime') }}" readOnly></input>
                    </div>
                    <div class="col-md-12 span_container_first_session">
                      <label class="span_label">Primera Sesión: </label> <input type="text" class="form-control" id="span_first_session" name="span_first_session" value="{{ old('span_first_session') }}" readOnly></input>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6" id="start_datetime_container">
                      <label for="start_datetime">Fecha y hora de la sesión:</label>
                    ...
                    <div class="col-md-6" id="end_datetime_container">
                      <label for="start_date">Fecha y hora de término:</label>
                    ...
                    <div class="col-md-12 counter_container">
                      <label> La sesión inicia en: </label> &nbsp; &nbsp;
          ...
          dayClick: function(date) {
            ...
            if( sessionsOfDay.length > 0 ){
              ...
              for (var i = 0; i < sessionsOfDay.length; i++) {
                ...
                sessionListText +=   '<span class="sessionListLabel">Categoría:</span> &nbsp; <span class="sessionListSpan">'+sessionsOfDay[i]['name']+'</span><br>';
                sessionListText +=   '<span class="sessionListLabel">Status:</span> &nbsp; <span class="sessionListSpan">'+elmStatusText+'</span><br>';
                sessionListText +=   '<span class="sessionListLabel">Fecha de la sesión:</span> &nbsp; <span class="sessionListSpan">'+(sessionsOfDay[i]['start_datetime']).substring(0, 10)+'</span><br>';
