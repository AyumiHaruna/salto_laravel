<!-- Navigation -->
 ...
 @ELSE
 <a class="navbar-brand js-scroll-trigger" href="{{ url('/') }}"> </a>
  <div class="nav-item logoNav">
        <img src="{{ asset('img/web/general/Saltum_triangulo_header.png') }}" alt="" id="Inicio" />
      </div>
...
<button class="navbar-toggler navbar-toggler-right custom-toggler-white" type="button">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto" id="nav-bar_container">
          @if(Session('role') === NULL)
            {{Session('role')}}
            <li class="nav-item">
     ...
     @IF( Session('role') != NULL )
        ...
        <li class="nav-item dropdown" id="profile_header_div">
          <a class="dropdown-toggle profile_header" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="{{ asset('files/usersFiles/'. ((Session('user')->photo != null)? Session('user')->photo : 'avatarPreview.png') ) }}" id="avatarPic"/>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            <!-- <a class="nav-link js-scroll-trigger navBtn" href="" id="">Datos de Usuario</a>
            <a class="nav-link js-scroll-trigger navBtn" href="" id="">Restablecer contraseña</a>
            <a class="nav-link js-scroll-trigger navBtn" href="" id="">Encuesta de Bienestar</a> -->

            <a class="nav-link js-scroll-trigger navBtn" href="{{ url('/logout') }}"> <i class="fas fa-power-off"></i> &nbsp; Cerrar Sesión</a>
